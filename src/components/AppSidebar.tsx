...
import {
  LayoutDashboard, MessageSquare, Kanban, Car,
  RotateCcw, Users, Repeat, Megaphone,
  ChevronRight, Sun, Moon, Settings, MessageCircle
} from "lucide-react";
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`relative z-10 flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors duration-200 ${
                  isActive
                    ? "text-foreground"
